...
class PermissionsTableSeeder extends Seeder
{
    public function run()
    {
        DB::table('permissions')->insert([
            ...
            ['id' => 8, 'name' => 'Agregar Servicios', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 9, 'name' => 'Editar Servicios', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 10, 'name' => 'Eliminar Servicio', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 11, 'name' => 'Agregar Productos', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 12, 'name' => 'Editar Productos', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 13, 'name' => 'Eliminar Productos', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['id' => 20, 'name' => 'Vista Servicios', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
            ['id' => 21, 'name' => 'Vista Productos', 'guard_name' => 'web', 'created_at' => now(), 'updated_at' => now()],
