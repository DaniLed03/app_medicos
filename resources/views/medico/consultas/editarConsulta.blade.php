...
<body>
    ...
    <p><strong>Nombre:</strong> {{ $consulta->cita->paciente->nombres }} {{ $consulta->cita->paciente->apepat }} {{ $consulta->cita->paciente->apemat }}</p>
    ...
    <p><strong>Género:</strong> {{ $consulta->cita->paciente->genero }}</p>
