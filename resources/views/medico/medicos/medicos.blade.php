            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg">
                <div class="p-6 text-gray-900">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="bg-white p-4 shadow-2xl rounded-md flex items-center space-x-4">
                                ...
                                <div class="text-center">
                                    <h2 class="text-lg font-bold">Total Médicos: {{ $totalMedicos }}</h2>
                                </div>
                            </div>
                    ...
                    <div class="overflow-x-auto bg-white dark:bg-neutral-700">
                        <table id="medicosTable" class="display nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Nombres</th>
                            ...
                            <tbody>
                                @foreach($medicos as $medico)
                                    <tr>
                                        <td>{{ $medico->nombres }} {{ $medico->apepat }} {{ $medico->apemat }}</td>
                                        <td>{{ \Carbon\Carbon::parse($medico->fechanac)->format('j M, Y') }}</td>
                                        <td>{{ $medico->sexo }}</td>
                                        <td>{{ $medico->telefono }}</td>
                                        <td>{{ $medico->email }}</td>
                                        <td>
                                            <a href="#" data-id="{{ $medico->id }}" class="text-blue-500 hover:underline editarMedico">Editar</a>
        ...
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-2">
                        @include('medico.medicos.agregarMedico')
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center min-h-screen">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="border-t border-gray-200 mt-4"></div>
                    <div class="mt-2" id="formEditarMedico">
...
<script>
    $(document).ready(function() {
        ...
        document.querySelectorAll('.editarMedico').forEach(button => {
