        ...
        <div class="max-w-screen-xl mx-auto px-4" x-data="{ open: false }">
            <div class="flex items-center justify-between h-10">
                <div class="hidden md:flex md:space-x-8">
                    ...
                    @can('Vista Citas')
                        @if(Auth::user()->userSetting && Auth::user()->userSetting->mostrar_agenda)
                            <div class="relative">
                        ...
                        @endif
                    @endcan
                    <!-- Verificar si la opción de "Caja" está habilitada antes de mostrar el botón y el dropdown -->
                    @if(Auth::user()->userSetting && Auth::user()->userSetting->mostrar_caja)
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            ...
                            <div x-show="dropdownOpen" @click.away="dropdownOpen = false" class="absolute mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 z-20">
                                <a href="{{ route('ventas.index') }}" class="block text-gray-700 px-4 py-2 text-sm dropdown-item hover:text-white relative">Cobro</a>
                    ...
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen" @click.away="dropdownOpen = false" class="absolute mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 z-20">
                            ...
                            @endrole
                            <a href="{{ route('configuracion.mostrar') }}" class="block text-gray-700 px-4 py-2 text-sm dropdown-item hover:text-white">Configurar Modulos</a>
