            ...
            <div class="bg-white overflow-hidden shadow-lg sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg mb-6">
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div class="text-center">
                                ...
                                <input type="text" id="talla" name="talla" class="form-input w-full bg-gray-50 border border-gray-300 rounded-lg p-2" value="{{ $consulta->talla }}" disabled>
                            </div>
                            <div class="text-center">
                                <label class="block font-semibold">Temperatura</label>
                                <input type="text" id="temperatura" name="temperatura" class="form-input w-full bg-gray-50 border border-gray-300 rounded-lg p-2" value="{{ $consulta->temperatura }}" disabled>
                            </div>
                            <div class="text-center">
                                <label class="block font-semibold">Saturación de oxígeno</label>
                                <input type="text" id="saturacion_oxigeno" name="saturacion_oxigeno" class="form-input w-full bg-gray-50 border border-gray-300 rounded-lg p-2" value="{{ $consulta->saturacion_oxigeno }}" disabled>
                            </div>
                            <div class="text-center">
                                <label class="block font-semibold">Frecuencia cardíaca</label>
                                <input type="text" id="frecuencia_cardiaca" name="frecuencia_cardiaca" class="form-input w-full bg-gray-50 border border-gray-300 rounded-lg p-2" value="{{ $consulta->frecuencia_cardiaca }}" disabled>
                            </div>
                            <div class="text-center">
                                <label class="block font-semibold">Peso</label>
                                <input type="text" id="peso" name="peso" class="form-input w-full bg-gray-50 border border-gray-300 rounded-lg p-2" value="{{ $consulta->peso }}" disabled>
                            </div>
                            <div class="text-center">
                                <label class="block font-semibold">Tensión arterial</label>
                                <input type="text" id="tension_arterial" name="tension_arterial" class="form-input w-full bg-gray-50 border border-gray-300 rounded-lg p-2" value="{{ $consulta->tension_arterial }}" disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('consultas.update', $consulta->id) }}">
                        ...
                        <input type="hidden" name="hidden_talla" value="{{ $consulta->talla }}">
                        <input type="hidden" name="hidden_temperatura" value="{{ $consulta->temperatura }}">
                        <input type="hidden" name="hidden_saturacion_oxigeno" value="{{ $consulta->saturacion_oxigeno }}">
                        <input type="hidden" name="hidden_frecuencia_cardiaca" value="{{ $consulta->frecuencia_cardiaca }}">
                        <input type="hidden" name="hidden_peso" value="{{ $consulta->peso }}">
                        <input type="hidden" name="hidden_tension_arterial" value="{{ $consulta->tension_arterial }}">
                        ...
                        <div class="flex flex-wrap -mx-3">
                                ...
                                @foreach($productos as $producto)
                                    <div class="mb-2 flex items-center justify-between">
                                        <label class="flex items-center">
                                            <input type="checkbox" name="productos[]" value="{{ $producto->id }}" data-precio="{{ $producto->precio }}" class="producto-checkbox mr-2" {{ in_array($producto->id, $consulta->productos->pluck('id')->toArray()) ? 'checked' : '' }}>
                            ...
                            <div class="bg-gray-100 p-6 rounded-lg mb-6 flex-1 mx-3">
                                ...
                                @foreach($servicios as $servicio)
                                    <div class="mb-2 flex items-center justify-between">
                                        <label class="flex items-center">
                                            <input type="checkbox" name="servicios[]" value="{{ $servicio->id }}" data-precio="{{ $servicio->precio }}" class="servicio-checkbox mr-2" {{ in_array($servicio->id, $consulta->servicios->pluck('id')->toArray()) ? 'checked' : '' }}>
                        ...
                        <div class="mt-6">
                            <button type="submit" class="bg-green-500 text-white p-4 rounded">Guardar Cambios</button>
                            <a href="{{ route('consultas.index') }}" class="bg-gray-500 text-white p-4 rounded">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
