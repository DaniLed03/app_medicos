            ...
            <div class="px-6 py-4">
                <form method="POST" action="{{ route('secretarias.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nombres" id="nombres" class="w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
                        <label for="apepat" class="block text-gray-700">Apellido Paterno:</label>
                        <input type="text" name="apepat" id="apepat" class="w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
                        <label for="apemat" class="block text-gray-700">Apellido Materno:</label>
                        <input type="text" name="apemat" id="apemat" class="w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
                        <label for="fechanac" class="block text-gray-700">Fecha de Nacimiento:</label>
                        <input type="date" name="fechanac" id="fechanac" class="w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
                        <label for="telefono" class="block text-gray-700">Teléfono:</label>
                        <input type="text" name="telefono" id="telefono" class="w-full px-3 py-2 border rounded" required>
                    </div>
                    <div class="mb-4">
